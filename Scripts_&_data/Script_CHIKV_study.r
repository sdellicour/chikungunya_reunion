...
mtext(expression("Pearson correlation"~"="~"0.95"), at=2160, line=-0.70, cex=0.75, col=rgb(222,67,39,255,maxColorValue=255))
...
mtext(expression("Pearson correlation"~"="~"0.86"), at=2160, line=-0.70, cex=0.75, col=rgb(222,67,39,255,maxColorValue=255))
mtext(expression(R^2~"="~"0.75"), at=700, line=-1.80, cex=0.75, col=rgb(222,67,39,255,maxColorValue=255))
...
mtext(expression("Pearson correlation"~"="~"0.82"), at=1978.2, line=-0.70, cex=0.75, col=rgb(222,67,39,255,maxColorValue=255))
...
mtext(expression("Pearson correlation"~"="~"0.84"), at=1978.2, line=-0.70, cex=0.75, col=rgb(222,67,39,255,maxColorValue=255))
